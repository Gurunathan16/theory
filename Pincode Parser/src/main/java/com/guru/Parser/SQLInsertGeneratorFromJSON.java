...
public class SQLInsertGeneratorFromJSON {
    public static void begin() throws IOException {
        ...
        JsonNode root = objectMapper.readTree(new File("pinCode.json"));
        ...
        for (JsonNode record : records) {
            ...
            if (!districtMap.containsKey(districtKey)) {
                ...
                districts.add("INSERT INTO district VALUES (" + (districtId - 1) + ", '" + district + "', "
                        + stateMap.get(state) + ");");
            }

            if (!pinCodeSet.contains(pinCode)) {
                pinCodes.add("INSERT INTO pinCode VALUES (" + pinCodeId++ + ", " + pinCode + ", "
        ...
        BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("data.sql"));
